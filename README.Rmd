...
Constructs confidence intervals for total causal effects based on observational data alone. 
...
Small example using the frequently studied protein expression data (Sachs et al., Causal protein-signaling networks derived from multiparameter single-cell data).
...
# Reorder data, we are interested in the effect of PKC on Jnk and vice versa
